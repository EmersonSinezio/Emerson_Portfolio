...
export const projects: Project[] = [
  {
    ...
    category: "Front-end",
    description:
      "E-commerce moderno inspirado na Apple com React, TypeScript e Tailwind.",
    longDescription:
      "Uma aplicação web moderna e responsiva de e-commerce inspirada no design minimalista e elegante da Apple. Desenvolvida com React 19, TypeScript, Vite e Tailwind CSS. Conta com carrinho global (Context API), animações fluidas (Framer Motion), Lazy Loading, notificações Toast e design totalmente responsivo.",
  ...
  },
  {
    ...
    longDescription:
      "Aplicação web para delivery de comida com interface intuitiva e moderna. Inclui listagem de restaurantes, cardápios e carrinho de compras.",
  ...
  },
  {
    ...
    category: "Front-end",
    description:
      "E-commerce moderno de sneakers com Next.js 15, TypeScript e Zustand.",
    longDescription:
  ...
  },
  {
    ...
    category: "Back-end",
    description:
      "Aplicação fullstack para gerenciamento de anotações, tarefas e produtividade com Calendário, Kanban e Dashboard.",
    longDescription:
      "Aplicação fullstack para gerenciamento de anotações, tarefas e produtividade. Além de anotações seguras, o sistema oferece um Calendário interativo para visualizar tarefas por data, Quadro Kanban para gestão de projetos (A Fazer, Em Progresso, Concluído) e um Dashboard com estatísticas detalhadas. Conta com interface moderna usando Tailwind CSS e segurança reforçada com autenticação JWT.",
    image: "/assets/daynotes_home.png",
    gif: "/assets/daynotes_navigation_v2.gif",
    ...
    howToRun: [
      ...
      "Configure o Frontend: cd front && npm install",
      "Inicie os serviços: npm run dev (em terminais separados)",
      "Acesse: http://localhost:3000",
    ],
    screenshots: [],
    techStack: [
    ...
    tags: ["Fullstack", "Productivity", "Kanban", "Calendar", "Dashboard"],
  },
  {
    id: 5,
    ...
    category: "Back-end",
    description:
      "Aplicação desktop completa em Java + JavaFX para gerenciamento de estoque com PostgreSQL.",
    longDescription:
...
export const timeline: TimelineEntry[] = [
  {
    ...
    description:
      "Suporte a sistemas internos (ERP), monitoramento de acessos e infraestrutura de redes. Desenvolvimento de scripts para automação de rotinas simples de TI. Resolução de chamados técnicos e garantia de disponibilidade dos serviços críticos.",
  ...
  },
  {
    ...
    endDate: "2025-09-01",
    description:
      "Suporte básico a sistemas corporativos e manutenção preventiva de infraestrutura. Triagem de chamados e gestão de contas de tecnologia.",
  ...
  },
  {
    ...
    endDate: "2026-12-31",
    description:
      "Cursando o 4º período. Foco em desenvolvimento de software, análise de sistemas e engenharia de software.",
  ...
  },
  {
    ...
    endDate: "2023-12-31",
    description:
      "Formação intensiva em desenvolvimento Full Stack com foco em tecnologias modernas e práticas de mercado.",
